...
public typealias אָפּטיילונג = Section
public typealias קייקל = Circle
public typealias פֿירקאַנט = Rectangle
public typealias אויסוואַל = Picker
public typealias שאַלטער = Toggle
public typealias שיבער = Slider
public typealias פּראָגרעס_בליק = ProgressView
public typealias פֿאַר_יעדן = ForEach
public typealias אַפּ = App
